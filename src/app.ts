...
export async function generate(filePath: string, providedOptions?: Partial<GenerateOptions>) {
  ...
  const header = `// DO NOT EDIT: Code generated by "jsdoc-example-tester".\n`
  const printed = await print(ast, options)

  writeFileSync(`${dir}/${name}.example.test.ts`, header + printed)
}
